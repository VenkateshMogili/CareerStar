...
<form action="check_addcompanies.php" method="post" enctype="multipart/form-data">
<center><table width="50%">
<tr><td>Company Name: </td><td><input type="text" name="company" placeholder="Ex: Google, Facebook, Yahoo, Amazon, Wipro" class="form-control" autofocus required></td></tr>
<tr><td>About Company: </td><td><textarea name="about" style="height:100px;" placeholder="Ex: Google CEO is Sundher Pichai etc.,...." class="form-control" required></textarea></td></tr>
...
<tr><td>Choose Company Logo: </td><td><input type="file" name="upload" required></td><tr>
...
<?php
    $q=mysqli_query($con,"SELECT * FROM companies order by id LIMIT 100");
