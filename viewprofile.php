...
if(isset($_SESSION['s_id'])){
	$id=$_SESSION['s_id'];
	$sql=mysql_query("SELECT * FROM students where s_id='$id' ");
...
if ($profile==""){
	echo "<a href='#' onclick='load_page(\"profile.php?stuid=".$stuid."\")' title='click here to change your profile picture'><img src='images/profile.png' width='200' height='200' style='border-radius:100px;margin-left:-30px;'></a>";
}else{
	...
	echo "<b style='font-size:30px;margin-left:100px;text-align:center;color:white;text-shadow:1px 2px 3px #3399cc'>".$stuid."</b></tr></table></center><center><table><tr><td>";
